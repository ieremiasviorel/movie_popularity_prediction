...
C_parameter_file = open("C_parameter_low_values", "w")	

for C_val in [10, 30, 60]:
	print("C parameter value: {0: d}".format(C_val))
	C_parameter_file.write("value: " + str(C_val) + "\n")
	print("training")
	...
	C_parameter_file.write("train error: {0: .2f}\n".format(train_mean_error))
	C_parameter_file.write("test error: {0: .2f}\n".format(test_mean_error))	
