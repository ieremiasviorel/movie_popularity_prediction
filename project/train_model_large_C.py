...
svr_lin = SVR(kernel='linear', C=300, max_iter=7000)
print("start training")
svr_lin.fit(dataset_X[0 : train_size], dataset_Y[0 : train_size])
print("done training")

from sklearn.externals import joblib
joblib.dump(svr_lin, 'SVM_regression_large_C.pkl')

y_train_predict = svr_lin.predict(dataset_X[0 : train_size])
y_test_predict = svr_lin.predict(dataset_X[train_size : train_size + test_size])
